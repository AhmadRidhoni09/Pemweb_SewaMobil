    ...
    <div class="py-12">
      <div class="mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div>
          ...
          <?php endif; ?>
          <form class="w-full" action="<?php echo e(route('admin.type.update', $type->id)); ?>" method="post"
...
<?php endif; ?>
<?php /**PATH C:\laragon\www\vrom_AhmmadRidhoni\resources\views/admin/type/edit.blade.php ENDPATH**/ ?>